...
MethodCreationDTO <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      MethodCreationDTOObject <- list()
      if (!is.null(self$`uri`)) {
        MethodCreationDTOObject[['uri']] <- self$`uri`
      }
      if (!is.null(self$`name`)) {
        MethodCreationDTOObject[['name']] <- self$`name`
      }
      if (!is.null(self$`description`)) {
        MethodCreationDTOObject[['description']] <- self$`description`
      }
      if (!is.null(self$`exact_match`)) {
        MethodCreationDTOObject[['exact_match']] <- self$`exact_match`
      }
      if (!is.null(self$`close_match`)) {
        MethodCreationDTOObject[['close_match']] <- self$`close_match`
      }
      if (!is.null(self$`broad_match`)) {
        MethodCreationDTOObject[['broad_match']] <- self$`broad_match`
      }
      if (!is.null(self$`narrow_match`)) {
        MethodCreationDTOObject[['narrow_match']] <- self$`narrow_match`
      }

      MethodCreationDTOObject
    },
    fromJSON = function(MethodCreationDTOJson) {
      MethodCreationDTOObject <- jsonlite::fromJSON(MethodCreationDTOJson)
      if (!is.null(MethodCreationDTOObject$`uri`)) {
        self$`uri` <- MethodCreationDTOObject$`uri`
      }
      if (!is.null(MethodCreationDTOObject$`name`)) {
        self$`name` <- MethodCreationDTOObject$`name`
      }
      if (!is.null(MethodCreationDTOObject$`description`)) {
        self$`description` <- MethodCreationDTOObject$`description`
      }
      if (!is.null(MethodCreationDTOObject$`exact_match`)) {
        self$`exact_match` <- MethodCreationDTOObject$`exact_match`
      }
      if (!is.null(MethodCreationDTOObject$`close_match`)) {
        self$`close_match` <- MethodCreationDTOObject$`close_match`
      }
      if (!is.null(MethodCreationDTOObject$`broad_match`)) {
        self$`broad_match` <- MethodCreationDTOObject$`broad_match`
      }
      if (!is.null(MethodCreationDTOObject$`narrow_match`)) {
        self$`narrow_match` <- MethodCreationDTOObject$`narrow_match`
      }
    },
    fromJSONObject = function(MethodCreationDTOObject) {
      if (!is.null(MethodCreationDTOObject$`uri`)) {
        self$`uri` <- MethodCreationDTOObject$`uri`
      }
      if (!is.null(MethodCreationDTOObject$`name`)) {
    ...
    fromJSONString = function(MethodCreationDTOJson) {
      MethodCreationDTOObject <- jsonlite::fromJSON(MethodCreationDTOJson)
      self$`uri` <- MethodCreationDTOObject$`uri`
      self$`name` <- MethodCreationDTOObject$`name`
      self$`description` <- MethodCreationDTOObject$`description`
