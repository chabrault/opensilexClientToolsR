  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`entity_of_interest`)) {
        VariableUpdateDTOObject[['entity_of_interest']] <- self$`entity_of_interest`
      }
      ...
      if (!is.null(self$`species`)) {
        VariableUpdateDTOObject[['species']] <- self$`species`
      }
    ...
    fromJSON = function(VariableUpdateDTOJson) {
      ...
      if (!is.null(VariableUpdateDTOObject$`entity_of_interest`)) {
        self$`entity_of_interest` <- VariableUpdateDTOObject$`entity_of_interest`
      }
      ...
      if (!is.null(VariableUpdateDTOObject$`species`)) {
        self$`species` <- VariableUpdateDTOObject$`species`
      }
