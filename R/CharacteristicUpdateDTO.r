...
#' @export
CharacteristicUpdateDTO <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      CharacteristicUpdateDTOObject <- list()
      if (!is.null(self$`uri`)) {
        CharacteristicUpdateDTOObject[['uri']] <- self$`uri`
      }
      if (!is.null(self$`name`)) {
        CharacteristicUpdateDTOObject[['name']] <- self$`name`
      }
      if (!is.null(self$`description`)) {
        CharacteristicUpdateDTOObject[['description']] <- self$`description`
      }
      if (!is.null(self$`exact_match`)) {
        CharacteristicUpdateDTOObject[['exact_match']] <- self$`exact_match`
      }
      if (!is.null(self$`close_match`)) {
        CharacteristicUpdateDTOObject[['close_match']] <- self$`close_match`
      }
      if (!is.null(self$`broad_match`)) {
        CharacteristicUpdateDTOObject[['broad_match']] <- self$`broad_match`
      }
      if (!is.null(self$`narrow_match`)) {
        CharacteristicUpdateDTOObject[['narrow_match']] <- self$`narrow_match`
      }

      CharacteristicUpdateDTOObject
    },
    fromJSON = function(CharacteristicUpdateDTOJson) {
      CharacteristicUpdateDTOObject <- jsonlite::fromJSON(CharacteristicUpdateDTOJson)
      if (!is.null(CharacteristicUpdateDTOObject$`uri`)) {
        self$`uri` <- CharacteristicUpdateDTOObject$`uri`
      }
      if (!is.null(CharacteristicUpdateDTOObject$`name`)) {
        self$`name` <- CharacteristicUpdateDTOObject$`name`
      }
      if (!is.null(CharacteristicUpdateDTOObject$`description`)) {
        self$`description` <- CharacteristicUpdateDTOObject$`description`
      }
      if (!is.null(CharacteristicUpdateDTOObject$`exact_match`)) {
        self$`exact_match` <- CharacteristicUpdateDTOObject$`exact_match`
      }
      if (!is.null(CharacteristicUpdateDTOObject$`close_match`)) {
        self$`close_match` <- CharacteristicUpdateDTOObject$`close_match`
      }
      if (!is.null(CharacteristicUpdateDTOObject$`broad_match`)) {
        self$`broad_match` <- CharacteristicUpdateDTOObject$`broad_match`
      }
      if (!is.null(CharacteristicUpdateDTOObject$`narrow_match`)) {
        self$`narrow_match` <- CharacteristicUpdateDTOObject$`narrow_match`
      }
    },
    fromJSONObject = function(CharacteristicUpdateDTOObject) {
      if (!is.null(CharacteristicUpdateDTOObject$`uri`)) {
        self$`uri` <- CharacteristicUpdateDTOObject$`uri`
      }
      if (!is.null(CharacteristicUpdateDTOObject$`name`)) {
