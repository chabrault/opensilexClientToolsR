  ...
  public = list(
    ...
    toJSONString = function() {
       sprintf(
        ...
        jsonlite::toJSON(self$`financial_funding`,auto_unbox=TRUE, null = "null"),
        jsonlite::toJSON(self$`website`,auto_unbox=TRUE, null = "null"),
        lapply(self$`related_projects`, function(x) paste(paste0('"', x, '"'), sep=",")),
        lapply(self$`coordinators`, function(x) paste(paste0('"', x, '"'), sep=",")),
        lapply(self$`scientific_contacts`, function(x) paste(paste0('"', x, '"'), sep=",")),
        lapply(self$`administrative_contacts`, function(x) paste(paste0('"', x, '"'), sep=",")),
